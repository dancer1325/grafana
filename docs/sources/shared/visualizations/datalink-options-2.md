...
# _Data links_
* allow you to
  * link -- to -- other panels, dashboards, and external resources 
...
* see [Configure data links and actions](https://grafana.com/docs/grafana/<GRAFANA_VERSION>/panels-visualizations/configure-data-links/)
