...
| Alert rule evaluation                                                                                          | Alert evaluation \| Grafana                | Alert rule evaluation \| data source <br/> allow for horizontal scaling    |
| Scaling                                                                                                        | Alert rules are stored \|  Grafana database | Alert rules are stored \| data source <br/> allow for horizontal scaling |
