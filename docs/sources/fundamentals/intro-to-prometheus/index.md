...
* Observability
  * 's goal
    * understand your systems' internal state -- based on the -- data they produce
      * == infrastructure's health

* Prometheus
  * == monitoring and observability's core technology
    * simple
    * scalable
  * history
    * | 2012, SoundCloud
      * Reason:🧠insufficient observability's technologies 🧠
    * | 2018, CNCF incubation 
  * provides
    * robust data model
    * query language
